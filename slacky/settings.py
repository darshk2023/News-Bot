"""
Django settings for slacky project.
...
SECRET_KEY = 'django-insecure-#-ohv&+9c5ndbnyun3&=doe=yglg+^mq5xi&tn*l3z74%ire)z'
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '769b-38-53-178-162.ngrok-free.app'
]
...
INSTALLED_APPS = [
    ...
    'django_apscheduler'         # <== added this line
]
...
WSGI_APPLICATION = 'slacky.wsgi.application'
